import { z } from "zod"
import {passwordRegex, phoneEcuadorRegex, urlRegex, validateBirthDate, validateImage} from "@/lib/utils";
...
export const registerSchema = z.object({
    ...
    image: z
      .any()
      .optional()  // Si la imagen es opcional
      .refine((val) => validateImage(val), {
    ...
    socialNetwork: z
        .string()
        .regex(urlRegex, { message: "La URL no es válida. Asegúrate de que esté en formato correcto (ej. http:// o https://)." }),
    phone : z
        .string()
        .regex(phoneEcuadorRegex, { message: "Número de teléfono inválido. Debe tener el formato +593 o 0 seguido del código de área." })
